...
{OpenWindow=window.open("", "newwin", "height=650, width=800,toolbar=no,scrollbars=yes,menubar=no");
   ...
   OpenWindow.document.write("<h1>Help Page for TPLConvert</h1>")
...
{ var firstSpace = line.indexOf(' ');
  ...
  var species = (secondSpace > 0) ? line.substring(firstSpace+1, secondSpace) : ""; //blank if no space found

  var trailingText = (secondSpace > 0) ? line.substring(secondSpace, line.length) : "";
